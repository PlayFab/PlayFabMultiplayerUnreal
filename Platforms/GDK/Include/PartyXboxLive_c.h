...
{
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_UNAUTHORIZED_LOCAL_CHAT_USER = 0,
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_FAILED_TO_GET_TOKEN_AND_SIGNATURE_FOR_LOCAL_CHAT_USER = 1,
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_XBOX_LIVE_SERVICE_TEMPORARILY_UNAVAILABLE = 2,
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_INTERNET_CONNECTIVITY_ERROR = 3,
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_XBOX_LIVE_USER_NOT_SIGNED_IN = 4,
    PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON_UNKNOWN_ERROR = 5,
} PARTY_XBL_LOCAL_CHAT_USER_DESTROYED_REASON;

typedef enum PARTY_XBL_STATE_CHANGE_RESULT
{
    PARTY_XBL_STATE_CHANGE_RESULT_SUCCEEDED = 0,
    PARTY_XBL_STATE_CHANGE_RESULT_UNKNOWN_ERROR = 1,
    PARTY_XBL_STATE_CHANGE_RESULT_CANCELED_BY_TITLE = 2,
    PARTY_XBL_STATE_CHANGE_RESULT_USER_NOT_AUTHORIZED = 3,
    PARTY_XBL_STATE_CHANGE_RESULT_LOGIN_TO_PLAYFAB_THROTTLED = 4,
    PARTY_XBL_STATE_CHANGE_RESULT_PARTY_SERVICE_ERROR = 5,
    PARTY_XBL_STATE_CHANGE_RESULT_XBOX_LIVE_SERVICE_TEMPORARILY_UNAVAILABLE = 6,
    PARTY_XBL_STATE_CHANGE_RESULT_INTERNET_CONNECTIVITY_ERROR = 7,
    PARTY_XBL_STATE_CHANGE_RESULT_PLAYFAB_RATE_LIMIT_EXCEEDED = 8,
} PARTY_XBL_STATE_CHANGE_RESULT;

typedef enum PARTY_XBL_THREAD_ID
{
    PARTY_XBL_THREAD_ID_WEB_REQUEST = 0,
} PARTY_XBL_THREAD_ID;

typedef enum PARTY_XBL_STATE_CHANGE_TYPE
{
    PARTY_XBL_STATE_CHANGE_TYPE_CREATE_LOCAL_CHAT_USER_COMPLETED = 0,
    PARTY_XBL_STATE_CHANGE_TYPE_LOCAL_CHAT_USER_DESTROYED = 1,
    PARTY_XBL_STATE_CHANGE_TYPE_REQUIRED_CHAT_PERMISSION_INFO_CHANGED = 2,
    PARTY_XBL_STATE_CHANGE_TYPE_TOKEN_AND_SIGNATURE_REQUESTED = 3,
    PARTY_XBL_STATE_CHANGE_TYPE_LOGIN_TO_PLAYFAB_COMPLETED = 4,
    PARTY_XBL_STATE_CHANGE_TYPE_GET_ENTITY_IDS_FROM_XBOX_LIVE_USER_IDS_COMPLETED = 5,
...
{
    uint32_t /* PARTY_XBL_STATE_CHANGE_TYPE */ stateChangeType;
...
PartyError
PARTY_API
PartyXblSetProfilingCallbacksForMethodEntryExit(
...
PartyError
PARTY_API
PartyXblGetProfilingCallbacksForMethodEntryExit(
...
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_NONE == 0x0000);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_SEND_MICROPHONE_AUDIO == 0x0001);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_SEND_TEXT_TO_SPEECH_AUDIO == 0x0002);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_SEND_AUDIO == 0x0003);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_MICROPHONE_AUDIO == 0x0004);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_TEXT_TO_SPEECH_AUDIO == 0x0008);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_AUDIO == 0x000c);
PARTY_XBL_C_ASSERT(PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_TEXT == 0x0010);

PARTY_XBL_C_ASSERT(PARTY_GENDER_NEUTRAL == 0x0000);
PARTY_XBL_C_ASSERT(PARTY_GENDER_FEMALE == 0x0001);
PARTY_XBL_C_ASSERT(PARTY_GENDER_MALE == 0x0002);
